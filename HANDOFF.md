...
- `style.css`: Responsive layout, light dotted field, SVG rope styling, pull-out animations.
...
- The visible playfield is intentionally a light dotted field like the reference video, not an 8x8 square board.
- Arrows are SVG rope paths with arrow heads; the escape animation retracts the stroke while the head pulls outward.
- Easy, Normal, and Hard are hand-authored fixed levels for now. Keep this until the rope pull interaction feels right, then reintroduce generated levels.

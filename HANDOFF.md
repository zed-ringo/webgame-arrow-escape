...
- `style.css`: Responsive layout, dark puzzle tray, SVG arrow styling, animations.
...
- The visible playfield is intentionally a quiet dark tray, not an 8x8 square board.
- Arrows are SVG paths with arrow heads; they should feel like colorful tangled maze arrows rather than grid blocks.
